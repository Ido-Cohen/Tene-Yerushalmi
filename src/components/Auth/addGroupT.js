            ...
            <div className="max-w-md w-full space-y-8 white pt-5 rounded-lg ">
                ...
                <form onSubmit={(event => {handleSubmission(event)})}>
                    ...
                    <div className="flex justify-center items-center w-full pt-5">
                        <label htmlFor="dropzone-file" className="flex flex-col justify-center items-center max-w-md w-full h-53 rounded-lg border-2 bg-gray-700 hover:bg-gray-800 border-gray-800 border-dashed cursor-pointer dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
